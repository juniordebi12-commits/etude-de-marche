    ...
    <div className="container py-8">
      ...
      <div className="flex items-start justify-between mb-6 gap-4">
        ...
        <div className="flex gap-2">
          <Link to={`/surveys/${id}/take`} className="px-3 py-1 btn-primary">Collecter des réponses</Link>
          <button onClick={() => nav(`/dashboard/survey/${id}`)} className="px-3 py-1 btn-outline">Résultats</button>
          <Link to={`/editor?edit=${id}`} className="px-3 py-1 btn-outline">Modifier</Link>
        </div>
      </div>
